...
Fraction find_largest(Fraction f1,Fraction f2,Fraction f3)
{
...
{
  printf("the largest of %d/%d,%d/%d,%d/%d is %d/%d/n",f1.num,f1.den,f2.num,f2.den,f3.num,f3.den,largest.num,largest.den);
}
int main()
{
